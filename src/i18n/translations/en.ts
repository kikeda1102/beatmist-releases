const en: Record<string, string> = {
  ...
  "不具合のご報告の際は、ご利用のOS（Windows / macOS）とバージョン、BeatMistのバージョンもあわせてご記載ください。エラーの様子がわかるスクリーンショットや動画を共有いただけると、よりスムーズにサポートさせていただくことができます。":
    "When reporting a bug, please include your OS (Windows / macOS) and version, and your BeatMist version. Sharing screenshots or videos of the error helps us provide faster support.",
